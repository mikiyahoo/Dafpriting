        ...
        <section className="pt-32 pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {items.length === 0 ? (
                <p className="text-primary-navy/50 col-span-2 text-center py-12">Portfolio items coming soon.</p>
              ) : items.map((item) => (
                <div
                  key={item.id}
                  className="group p-8 border border-primary-navy/10 hover:border-primary-navy/30 hover:shadow-lg transition-all duration-300"
                >
                  {item.coverImage && (
