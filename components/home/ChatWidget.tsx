  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-5 py-3 bg-secondary text-bgPure rounded-full shadow-lg hover:bg-secondary/90 hover:-translate-y-0.5 transition-all duration-300 group"
        ...
        <div className="fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-48px)] bg-bgPure rounded-3xl shadow-elevated border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
          ...
          <div className="p-5 max-h-[500px] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                href={`mailto:${contactInfo.email}`}
                className="flex items-center justify-center gap-2 py-3 bg-primary text-bgPure rounded-xl text-sm font-semibold hover:bg-primary/90 hover:-translate-y-0.5 transition-all duration-300"
              >
              ...
              <a
                href="/contact"
                className="flex items-center justify-center gap-2 py-3 bg-secondary text-bgPure rounded-xl text-sm font-semibold hover:bg-secondary/90 hover:-translate-y-0.5 transition-all duration-300"
              >
                Contact Page
              </a>
            </div>
